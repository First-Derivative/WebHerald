...
urlpatterns = [
    ...
    path('api/comments/<int:comment_id>/modify', modifyComment, name='modifyComment'),
    path('api/comments/<int:comment_id>/getcontents', getCommentContents, name='getCommentContents')
]
